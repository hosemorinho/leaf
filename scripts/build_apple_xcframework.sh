...
cargo build -p $package $release_flag --no-default-features --features "default-aws-lc,outbound-select" --target x86_64-apple-darwin
cargo build -p $package $release_flag --no-default-features --features "default-aws-lc,outbound-select" --target aarch64-apple-darwin
cargo build -p $package $release_flag --no-default-features --features "default-aws-lc,outbound-select" --target aarch64-apple-ios
cargo build -p $package $release_flag --no-default-features --features "default-aws-lc,outbound-select" --target x86_64-apple-ios
cargo build -p $package $release_flag --no-default-features --features "default-ring,outbound-select" --target aarch64-apple-ios-sim
